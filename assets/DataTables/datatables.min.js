...
sNext:"التالي",sPrevious:"السابق"},sEmptyTable:"No data available in table",sInfo:"العرض _START_ الى _END_ من _TOTAL_ مدخلات",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"العرض _MENU_ المدخلات",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"البحث:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
