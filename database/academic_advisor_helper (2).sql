...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2023 at 01:56 AM
...
(999, 'سارة احمد2 الفوزان', 'sa.qalfozan@ju.edu.sa', '09999999999', '999', 1),
...
(421205425, 'ملاك تركي خالد2', 2, '2023-03-26', '0530244747', '421205425@ju.edu.sa', 1, 2);
...
--
-- AUTO_INCREMENT for table `table_header_program_study_plan`
--
ALTER TABLE `table_header_program_study_plan`
  MODIFY `Id_Plan` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
