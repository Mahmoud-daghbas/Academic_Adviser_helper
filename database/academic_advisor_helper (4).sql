...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 08, 2023 at 03:58 AM
...
--
-- Table structure for table `table_permision`
--

CREATE TABLE `table_permision` (
  `u_id` int(11) NOT NULL,
  `Id_Plan` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `table_permision`
--

INSERT INTO `table_permision` (`u_id`, `Id_Plan`) VALUES
(999, 2);
...
--
-- Table structure for table `teble_message`
--

CREATE TABLE `teble_message` (
  `Mess_Id` varchar(100) NOT NULL,
  `Type_Mess` int(11) NOT NULL,
  `Tital` text NOT NULL,
  `Text_Mess` longtext NOT NULL,
...
--
-- Indexes for table `table_permision`
--
ALTER TABLE `table_permision`
  ADD PRIMARY KEY (`u_id`,`Id_Plan`);
...
--
-- Indexes for table `teble_message`
--
ALTER TABLE `teble_message`
